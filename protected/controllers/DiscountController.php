...
class DiscountController extends RController
{
	/**
	...
	public function loadModel($id)
	{
        ...
        public function actionLookup()
        {
                ...
                $criteria->compare('LOWER(description)',strtolower($term),true);
                ...
                {
                        $returnArray[]=array(
                                'label'=>CHtml::encode($model->description.':'.$model->flat.':'.$model->percentage),
                                'value'=>CHtml::encode($model->description.':'.$model->flat.':'.$model->percentage),
                                'id'=>(int)$model->id,
                        );
                }
