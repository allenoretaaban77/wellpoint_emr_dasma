...
?>
<br/>
<div style="color:blue">You will create a diagnostic result <b>"Rapid Antigen Test (SALIVA)"</b></div>

<form method="post" action="<?= Yii::app()->createAbsoluteUrl('diagRapidantigentestsaliva/create/',array()) ?>" onsubmit="return submitThis();">
    ...
    *To search, type in the patient's <span style="color:blue">first name</span> or <span style="color:blue">last name</span> or <span style="color:blue">patient id</span>.
    ...
    <div style="width:100%;float:left;">
        <input type="hidden" name="diag" value="rapidtest" />
