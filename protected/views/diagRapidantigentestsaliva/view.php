...
$this->menu=array(
    ...
    array('label'=>'Edit This Record', 'url'=>array('diagRapidantigentestsaliva/update/'.$model->id)),
...
<h2>View Patient's Diagnostics for Rapid Antigen Test (SALIVA)</h2>
<div style="float:left;margin:0px 0px 5px 0px;">
<?php echo CHtml::link('[Edit This Result]',array('diagRapidantigentestsaliva/update/'.$model->id)); ?>
&nbsp;&nbsp;
<a target="_blank" href="<?= Yii::app()->createUrl("PrintDiagResult/FormRapidantigentestsaliva/Print/?resultid=".$model->id, array()) ?>">[Print This Result]</a>
&nbsp;&nbsp;
