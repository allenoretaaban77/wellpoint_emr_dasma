...
?>
<br/>
<div style="color:blue">You will create a diagnostic result <b>"Rapid COVID-19 Test"</b></div>

<form method="post" action="<?= Yii::app()->createAbsoluteUrl('diagRapidtest/create/',array()) ?>" onsubmit="return submitThis();">
