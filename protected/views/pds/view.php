...
$this->menu=array(
    ...
    array('label'=>'Print Follow-Up Form', 'url'=>array('printFollowUp','id'=>$model->id)),
    array('label'=>'Print PDS Aesthetics Form', 'url'=>array('PrintPdsAesthetic','id'=>$model->id)),
    array('label'=>'Print Treatment Schedule Form', 'url'=>array('PrintTreatment','id'=>$model->id)),
);
?>
