<div class="form"  name="hmoitems_doctor">
    ...
    <div class="row">
        ...
        <select onchange="serviceTypeOnchange(value)" name="HmoFormItemsCategorySupport[service_type]" id="HmoFormItemsCategorySupport_service_type">
            <option value="DIAGNOSTIC" selected="selected">Diagnostic</option>
            <option value="CONSULTATION">Consultation</option>
            <option value="PROCEDURE">Procedure</option>
            <option value="OTHERS">Consultation/Procedure</option>
        </select>
        <?php echo $form->error($model,'service_type'); ?>
        <script>
            var serviceTypeOnchange = function(value){
                /*switch(value){
                    case 'CONSULTATION':$("#services_box_doctor").hide();break;
                    default:$("#services_box_doctor").show();break;
                }*/
            }
        </script>
    </div>
