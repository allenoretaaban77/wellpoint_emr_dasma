...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'beginningpaymaya'); ?>
		<?php echo $form->textField($model,'beginningpaymaya'); ?>
		<?php echo $form->error($model,'beginningpaymaya'); ?>
	</div>

	<!--div class="row">
		<?php echo $form->labelEx($model,'beginning_gcash'); ?>
		<?php echo $form->textField($model,'beginning_gcash'); ?>
		<?php echo $form->error($model,'beginning_gcash'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'beginning_bpi'); ?>
		<?php echo $form->textField($model,'beginning_bpi'); ?>
		<?php echo $form->error($model,'beginning_bpi'); ?>
	</div-->
