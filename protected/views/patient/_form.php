<div class="form">
    ...
    <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        'htmlOptions' => array('enctype' => 'multipart/form-data', 'onsubmit' => 'return validateForm(this)'),
    )); ?>
    	...
    	<div class="row buttons">
            ...
            <!--input type="submit" name="yt0" value="Create" onclick="this.disabled=true; this.value='Please Wait...';"-->
            <!--input type="submit" name="yt0" value="Create" id="submitButton"-->
    	</div>
