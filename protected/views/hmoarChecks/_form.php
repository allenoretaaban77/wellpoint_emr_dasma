...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <fieldset>
     ...
     <fieldset>
        <legend>HMO & Billing Info</legend>
	...
	<fieldset>
        <legend>Exces & Misc Amounts</legend>
        <div class="row" >
        ...
        <div class="row">
            <?php echo $form->labelEx($model,'misc_xces'); ?>          
            <?php echo $form->textField($model,'misc_xces'); ?>
            &nbsp;
            Remarks :<?php echo $form->textField($model,'misc_xces_rem'); ?>
            <?php echo $form->error($model,'misc_xces'); ?>
        </div>
    </fieldset>    
