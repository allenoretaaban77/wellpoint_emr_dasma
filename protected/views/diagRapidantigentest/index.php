...
?>
<br/>
<div style="color:blue">You will create a diagnostic result <b>"Rapid Antigen Test (SWAB)"</b></div>

<form method="post" action="<?= Yii::app()->createAbsoluteUrl('diagRapidantigentest/create/',array()) ?>" onsubmit="return submitThis();">
