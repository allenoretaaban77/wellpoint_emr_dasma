...
class HmoarChecks extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('check_amnt, billed_amnt, wtax_amnt, provider_xces, member_xces, hmo_xces', 'numerical'),
			array('check_no, payto, pay_doc_name,hmo_xces_rem', 'length', 'max'=>250),
