 ...
 */
class HmoFormItemsCategorySupport extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, itemid, hmo_form_id, item_entry_date, item_avail_date, payto, claim_doctor_id, claim_doctor_name, diagnosis, med_service, service_type, req_doctor, charge_type, charge_fee, isapplied', 'safe', 'on'=>'search'),
		);
	}
