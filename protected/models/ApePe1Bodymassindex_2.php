...
class ApePe1Bodymassindex extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, ape_id, user_id, username, update_datetime, height_ft, height_in, height_cm, weight_lbs, weight_kg, bmi, bmi_uw, bmi_n, bmi_ow, bmi_oc1, bmi_oc2', 'safe', 'on'=>'search'),
		);
	}
