...
class PdsHmo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('notesx', 'length', 'max'=>255),
			array('pds_id', 'length', 'max'=>20),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, cardno, controlno, approvalcode, notesx, hmo_id, pds_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('notesx',$this->notesx,true);
