...
class FormRapidantigentestController extends Controller
{
    ...
    public function actionPrint(){
        ...
        $model=DiagRapidantigentest::model()->findByPk((int)$resultid); 
        $url = Yii::app()->getBasePath() ;
         
        $print = implode("", file(Yii::app()->getBasePath().'/modules/PrintDiagResult/includes/PrintFormRapidantigentest.html'));
