...
class FormBloodChemsiController extends Controller
{
    ...
    public function actionPrint(){
        ...
        $model=DiagResBloodchemsi::model()->findByPk((int)$resultid); 
         $url = Yii::app()->getBasePath() ;
         
        $print = implode("", file(Yii::app()->getBasePath().'/modules/PrintDiagResult/includes/PrintFormBloodChemsi.html'));
        ...
        $print = str_replace("[creatinine_clearance]",strtoupper($model->creatinine_clearance),$print); 
