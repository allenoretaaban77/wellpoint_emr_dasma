...
?>
<br/>
<div style="color:blue;font-size: 16px;">You will create a diagnostic result <b>"Blood Chemistry (SI)"</b></div>

<form method="post" action="<?= Yii::app()->createAbsoluteUrl('DiagResBloodchemsi/create',array()) ?>" onsubmit="return submitThis();">
