<?php
if($_GET['task']== 'doctrnxs'){
    $url = "/hmoarreports/reports/bcreport?task={$_GET['task']}&docid={$_GET['docid']}&start={$_GET['start']}&end={$_GET['end']}";
...
if($_GET['task']== 'hmopaidtrnxs'){
    $url = "/hmoarreports/reports/bcreport?task={$_GET['task']}&docid={$_GET['docid']}&start={$_GET['start']}&end={$_GET['end']}&paid={$_GET['paid']}";
}
...
?>
    ...
    <form method="get" action="/hmoarreports/reports/bcreport" id="yw1">    
        <fieldset>
            ...
            <div class="wide form">
            <label for="HmoFormItems_hmo_company">HMO Company</label>    
            <input type="text" maxlength="250" id="HmoFormItems_hmo_company" name="Search[hmo_company]" value="<?php echo $_GET['Search']['hmo_company']?>">
            <br/>
