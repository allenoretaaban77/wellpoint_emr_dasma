...
<li><a href="<?php echo Yii::app()->controller->createUrl('/Hmi/',array()); ?>">HMI Billings</a></li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="<?php echo Yii::app()->controller->createUrl('/user/admin',array()); ?>">Users</a></li>
                                <li><a href="<?php echo Yii::app()->controller->createUrl('/rights',array()); ?>">Rights</a>
                                    <ul>
                                        <li><a href="<?php echo Yii::app()->controller->createUrl('/rights/authItem/permissions',array()); ?>">Permissions</a>
                                            <ul>
                                                <li><a href="<?php echo Yii::app()->controller->createUrl('/rights/authItem/tasks',array()); ?>">Tasks</a></li>
                                                <li><a href="<?php echo Yii::app()->controller->createUrl('/rights/authItem/operations',array()); ?>">Operations</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="<?php echo Yii::app()->controller->createUrl('/rights/authItem/roles',array()); ?>">Roles</a>
                                            <ul>
            ...
            <div id="mid_div">
                ...
                <div id="title">
                    ELECTRONIC MEDICAL RECORDS SYSTEM - SM ROSARIO
                </div>
                <div id="green_ul"></div>
