...
<head>
    ...
    <body>
        ...
        <div id="main_div">
            ...
            <div id="left_div">
                <div id="left_content">
                    <a href="javascript:void(0)" onclick="toggleSideMenu('hide')" style="color:#ccc" >Hide Panel (X)</a>
                    <br/><br/>
                    MENU TREE
                    ...
                    <ul id="browser" class="filetree">
                        ...
                        <li class="closed"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/menu2.png" style="position: relative;margin:0 0 -5px 5px;"> PATIENT
                            <ul>
                                ...
                                <li>PDS
                                    <ul>
                                        <li><a href="<?php echo Yii::app()->controller->createUrl('/pds/create',array()); ?>">Add PDS</a></li>
										<li><a href="<?php echo Yii::app()->controller->createUrl('/pds/createWithDoctor',array()); ?>">Add PDS (w/ doctor)</a></li>
                                        <li><a href="<?php echo Yii::app()->controller->createUrl('/pds/admin',array()); ?>">PDS List</a></li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                Reports - Check
                                <ul>
                                    <li><a href="<?php echo Yii::app()->controller->createUrl('/hmoarreports/reports/Bcreport/task/hmochecks_params',array()); ?>">HMO Checks Report</a></li>
                                    <li><a href="<?php echo Yii::app()->controller->createUrl('/hmoarreports/reports/Bcreport/task/hmoalldocs_params',array()); ?>">Checks HMO All Doctors</a></li>
                                    <li><a href="<?php echo Yii::app()->controller->createUrl('/hmoarreports/reports/Bcreport/task/hmoindchecks_params',array()); ?>">Individual Checks Summary</a></li>
